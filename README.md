...
API desenvolvida pela Giuliana Bezerra do canal [youtube](https://www.youtube.com/watch?v=SsWZ4O9iWuo&t=568s) com base no desafio proposto pelo ClickBus neste [link](https://github.com/RocketBus/quero-ser-clickbus/tree/master/testes/backend-developer).

Esta é uma API para gerenciar lugares (CRUD)
